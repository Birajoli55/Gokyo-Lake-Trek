...
export default function Trek9Days() {
  ...
  return (
    <main className="bg-stone-50 overflow-x-clip">
      ...
      >
        <div className="max-w-2xl mx-auto mb-8 text-center">
          <p className="text-stone-200 text-lg md:text-xl leading-relaxed text-balance font-medium drop-shadow-md">
            Our 9-day itinerary is the "sweet spot" of Himalayan trekking, engineered for those who want the full majesty of the Gokyo Lakes without the time commitment of a two-week expedition.
            <span className={`transition-all duration-700 ${isExpanded ? 'opacity-100' : 'opacity-0 h-0 w-0 pointer-events-none inline-block overflow-hidden'}`}>
              {" "}This balanced route includes essential acclimatization while maintaining a steady momentum, taking you from the vibrant streets of Namche to the high-altitude serenity of the turquoise lakes.
            </span>
            <button
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
          <button
            onClick={() => openBooking('Short & Intense Gokyo (9 Days)')}
      ...
      <div id="itinerary" className="scroll-mt-20">
            ...
            <div className="xl:col-span-7 space-y-12">
              <div className="space-y-6">
                ...
                <h2 className="text-4xl md:text-5xl font-black text-stone-900 leading-tight">
                  The Smart <span className="text-brand-800 italic">Himalayan Balance</span>
                </h2>
        ...
        <Section title="Day-by-Day Trek Plan" subtitle="Your Efficient Journey">
