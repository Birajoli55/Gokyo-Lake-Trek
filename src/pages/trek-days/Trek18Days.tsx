...
export default function TrekGokyoChoLaEBC() {
  ...
  return (
    <main className="bg-stone-50 overflow-x-clip">
      ...
      >
        <div className="max-w-2xl mx-auto mb-8 text-center">
          <p className="text-stone-200 text-lg md:text-xl leading-relaxed text-balance font-medium drop-shadow-md">
            This is the ultimate Himalayan odyssey, combining the serene Gokyo Lakes with the legendary Everest Base Camp in a single, epic journey.
            <span className={`transition-all duration-700 ${isExpanded ? 'opacity-100' : 'opacity-0 h-0 w-0 pointer-events-none inline-block overflow-hidden'}`}>
              {" "}Cross the challenging Cho La Pass, summit both Gokyo Ri and Kala Patthar, and stand at the foot of the world's highest peak on this comprehensive grand circuit.
            </span>
            <button
      ...
      <div id="itinerary" className="scroll-mt-20">
            ...
            <div className="xl:col-span-7 space-y-12">
              <div className="space-y-6">
                ...
                <h2 className="text-4xl md:text-5xl font-black text-stone-900 leading-tight">
                  The Ultimate <span className="text-brand-800 italic">Himalayan Odyssey</span>
                </h2>
        ...
        <Section title="Day-by-Day Trek Plan" subtitle="Your Epic Journey">
